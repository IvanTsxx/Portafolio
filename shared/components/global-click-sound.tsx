...
import { clickSoftSound } from "@/shared/lib/click-soft";
import { decodeAudioData, playSound } from "@/shared/lib/sound-engine";
...
export function GlobalClickSound() {
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      if (clickable) {
        playSound(clickSoftSound.dataUri, { volume: 0.05 }).catch(() => {
