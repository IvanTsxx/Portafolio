...
export default async function Image({
  ...
  if (project.coverImage) {
    const coverImage = project.coverImage.replace(/\.webp$/, ".png");
    return new ImageResponse(
      <div
        style={{
          display: "flex",
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage:
          "radial-gradient(circle at 80% 20%, rgba(94, 156, 118, 0.1) 0%, transparent 40%), radial-gradient(circle at 20% 80%, rgba(94, 156, 118, 0.08) 0%, transparent 40%)", // Subtle sage green blobs
      }}
    >
      <div
        style={{
