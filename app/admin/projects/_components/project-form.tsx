...
export function ProjectForm({ technologies }: ProjectFormProps) {
...
export function NewProjectPage({ technologies }: ProjectFormProps) {
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-bold text-3xl tracking-tight">Nuevo proyecto</h1>
